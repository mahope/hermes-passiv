...
- ER DU BLOKERET: start noget NYT frem for at pudse det gamle. Skriv blokeringen som EN linje i STATUS.md og gaa videre. Gentag den ALDRIG iteration efter iteration.
- MAAL ALDRIG SUCCES PAA EGNE TESTS. Er tallet 0, saa skriv 0.
