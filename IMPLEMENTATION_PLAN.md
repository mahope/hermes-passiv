...
- `DEPLOY`: `VERIFICÉR DEPLOY: DeskUptime-siderne siger at desktop-appen er Pro, ikke gratis 003f60d 26/9` — GitHub Actions deployer med det samme (\`site/**\` og \`tools/**\` er i path-filteret), og diffen rører **to købssider** på \`deskuptime.com\` plus katalogen der porten læser, så den skal verificeres på indhold. Verificér:
