...
- `NEXT_TASK`: `30 — den samme påstandsklasse i bloggeneratorerne: `tools/make_blog_sheets_en.py`, `tools/make_blog_notion_en.py` og `tools/make_hub_copy_clean.py` skriver "Clean Copy works entirely inside your browser" / "runs entirely in your editor" i fem publicerede FAQ'er. Redigér generatorerne, ikke `site/blog/*.html`, ellers regenereres teksten. Derefter: kør `reports/weekly/` for den næste konverteringsmulighed. Bemærk at disse fem siders *indholds*-påstand ("the table never leaves your machine") er sand — kun "works entirely" er for bred. 24 og 25 er BLOCKED: kræver Mads.`
- `PLAN_COMMIT`: `—this commit— kode + plan i samme commit, ingen ren plan-commit`
- `BASELINE`: `main@63d83a0`
- `LAST_BRANCH`: `ceo/pro-claim-honesty`
- `TASK_ATTEMPTS`: `18: 1/1., 19: 1/1., 20: 1/1., 21: 1/1., 22: 1/1., 23: 1/1., 26: 1/1., 27: 1/1., 28: 1/1., 29: 1/1.`
