...
- `NEXT_TASK`: `32 — udfyld den hule EAA-scanner-tabel i site/blog/eaa-compliance-scanner-desktop.html (4 tomme celler). Samme fejlform som opgave 31, men kræver en beslutning fra ❓ punkt 5 først: EAA Scanner Pro har ingen product_key, så gratis/Pro-værdierne kan ikke fastslås af koden. Undgå at opfinde dem.`
- `PLAN_COMMIT`: `— denne iteration: kode + plan i samme commit, ingen ren plan-commit`
- `BASELINE`: `main@daed5d8`
- `LAST_BRANCH`: `ceo/free-tier-clarity`
- `TASK_ATTEMPTS`: `18: 1/1., 19: 1/1., 20: 1/1., 21: 1/1., 22: 1/1., 23: 1/1., 26: 1/1., 27: 1/1., 28: 1/1., 29: 1/1., 30: 1/1., 31: 1/1.`
...
### 32. UFÆRDIG — den samme hule tabel på EAA-scannerens blogside
