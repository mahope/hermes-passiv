...
- `DEPLOY`: `VERIFICÉR DEPLOY: EUComply Pro-siden må ikke længere sige at browseren analyserer <merge-sha> 26/9` — GitHub Actions deployer med det samme (\`site/**\`, \`tools/**\`, \`tests/**\` er i path-filteret). Verificér på **indhold**, ikke HTTP 200:
