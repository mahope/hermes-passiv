...
- `DEPLOY` (opgave 50, ÅBEN): `VERIFICÉR DEPLOY: /da/activate/ er publiceret med egen købsknap, egen sitemap-post og sprogskift på begge sprog 8b12315 26/9` — GitHub Actions deployer med det samme (`site/**`, `build_sites.py` og `tools/**` er i path-filteret). Verificér på **indhold**:
