...
- `ITERATION_ID`: `paid-ebook-paendelse-2026-09-26`
...
- `BASELINE`: `main@72621cd`
- `LAST_BRANCH`: `ceo/paid-ebook-paendelse`
- `NEXT_TASK`: `42 — gaten der fanger en pris på et produkt, der ikke kan købes. Se opgave 42.`
...
- `TASK_ATTEMPTS`: `18: 1/1., 19: 1/1., 20: 1/1., 21: 1/1., 22: 1/1., 23: 1/1., 26: 1/1., 27: 1/1., 28: 1/1., 29: 1/1., 30: 1/1., 31: 1/1., 32: 0/0 (kræver Mads), 33: 1/1., 34: 1/1., 35: 1/1., 37: 1/1., 38: 1/1., 39: 1/1., 40: 1/1., 41: 1/1.`
...
### 42. UFÆRDIG — porten der fanger en pris på en produkt, der ikke kan købes
