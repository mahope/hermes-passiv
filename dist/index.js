...
async function onRequest(context) {
  ...
  return new Response(JSON.stringify({ ok: true, message: "Function works!" }), {
    status: 200,
    headers
  });
}
...
async function onRequest2(context) {
  ...
  try {
    const response = await fetch(targetUrl.toString(), {
      ...
      redirect: "follow"
      // Maks 5 MB — vi scanner kun HTML, ikke store downloads
    });
...
// ../../.wrangler/tmp/pages-ANYLi4/functionsRoutes-0.18657338483288843.mjs
var routes = [
  {
    routePath: "/ping",
    mountPath: "/",
