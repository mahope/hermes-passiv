...
<p class="muted">Last updated: September 25, 2026</p>
...
per purchaser for use on any number of machines you own. Some products are sold
as a one-time payment, others as a yearly subscription; every product page
states which one it is.</p>

<h2>Cancelling a subscription</h2>
<p>Clean Copy Pro, EUComply Pro and Page Profile Pro renew yearly. You cancel
yourself at any time in <a href="https://billing.stripe.com/p/login/6oU4gy76PgvgdBIdAXbMQ00" rel="nofollow noopener">Stripe's billing portal</a>,
where you also find your invoices and can update your card, address or VAT ID.
Cancelling stops the renewal; the license stays valid until the end of the
period you have already paid for. One-time purchases have no renewal and
nothing to cancel.</p>
